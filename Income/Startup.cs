...
//            var accessImpleAndInterfaces = AssemblyHelper.GetImpleAndInterfaces("Income.Data", "Repository");
//            foreach (var v in accessImpleAndInterfaces)
//                services.AddScoped(v.Value[0], v.Key);
//            var logicImpleAndInterfaces = AssemblyHelper.GetImpleAndInterfaces("Income.Bussiness", "Service");
